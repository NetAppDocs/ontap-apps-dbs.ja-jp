...
| newSyncInterval | Kubernetes に vSphere CSI を使用していない場合は、per https://knowledge.broadcom.com/external/article/415074/reducing-or-disabling-excessive-vsan-cns.html["VMware KB 415074"^] | いいえ 
